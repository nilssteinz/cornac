# Copyright 2025 Nils Steinz. All Rights Reserved.
#
...
class LightGCN_geom(Recommender, ANNMixin):
    """
    LightGCN
    ...
    def fit(self, train_set, val_set=None):
        ...
        for _ in pbar:
            ...
            for batch_user, batch_pos, batch_neg in tqdm(
                ...
                accum_loss += float(batch_loss.detach()) * pos_rank.numel()
